...
TaskMate is an efficient advanced Todo app built using the MERN stack.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/salmanmhd/TaskMate
   ```
...
```json
{
  ...
  "notes": "Remember to deploy once completed"
}
```
